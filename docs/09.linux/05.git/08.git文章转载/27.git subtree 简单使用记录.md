...
## Sub module vs Sub tree[](#sub-module-vs-sub-tree)
...
## 为什么要使用 git subtree?[](#为什么要使用-git-subtree)
...
## 什么时候使用 git subtree?[](#什么时候使用-git-subtree)

*   多个项目共同使用一整块代码库，并且这个依赖的代码库再快速迭代的时候
*   将一部分的代码从一个仓库独立出去，并且保留这个部分提交历史的时候

## git subtree 相关命令[](#git-subtree-相关命令)
...
### 使用 git subtree 来管理 vim plugin[](#使用-git-subtree-来管理-vim-plugin)
...
### 使用 git subtree 来管理博客的主题[](#使用-git-subtree-来管理博客的主题)
...
### 子项目将修改提交到 upstream 的过程变得复杂[](#子项目将修改提交到-upstream-的过程变得复杂)
...
### 需要学习 subtree 的 merge 方法[](#需要学习-subtree-的-merge-方法)
...
2.  [https://blog.walterlv.com/post/performance\-of\-git\-subtree.html](https://blog.walterlv.com/post/performance-of-git-subtree.html) [↩](https://einverne.github.io/post/2020/04/git-subtree-usage.html#fnref:split)

3.  [https://github.com/apenwarr/git\-subtree/blob/master/git\-subtree.txt](https://github.com/apenwarr/git-subtree/blob/master/git-subtree.txt)
...
4.  [https://mirrors.edge.kernel.org/pub/software/scm/git/docs/howto/using\-merge\-subtree.html](https://mirrors.edge.kernel.org/pub/software/scm/git/docs/howto/using-merge-subtree.html) [↩](https://einverne.github.io/post/2020/04/git-subtree-usage.html#fnref:merge)

5.  [https://help.github.com/en/github/using\-git/about\-git\-subtree\-merges](https://help.github.com/en/github/using-git/about-git-subtree-merges) [↩](https://einverne.github.io/post/2020/04/git-subtree-usage.html#fnref:m2)

6.  [https://stackoverflow.com/a/25311871/1820217](https://stackoverflow.com/a/25311871/1820217) [↩](https://einverne.github.io/post/2020/04/git-subtree-usage.html#fnref:m3)
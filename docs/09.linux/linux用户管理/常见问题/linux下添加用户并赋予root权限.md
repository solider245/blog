---
title: linux下添加用户并赋予root权限
date: 2020-10-12 12:09:51
permalink: /pages/3a3d99/
categories:
  - linux用户管理
  - 常见问题
tags:
...
<!--
 * @Author: 中箭的吴起
 * @Date: 2020-07-17 08:05:39
 * @LastEditTime: 2020-07-17 08:05:40
 * @LastEditors: 中箭的吴起
 * @Description: 
 * @FilePath: \科技文章c:\Users\admin\OneDrive\studybook\linux\linux用户管理\常见问题\linux下添加用户并赋予root权限.md
 * @日行一善，每日一码
--> 

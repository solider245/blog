...
set -g @prefix_highlight_empty_attr 'fg=colour233,bg=green'
...
'set -w synchronize-panes off; set -w window-style fg=colour238,bg=black' \
'set -w synchronize-panes on; set -w window-style fg=colour238,bg=colour53'


#set inactive/active window styles
set -g window-style 'fg=colour238,bg=black'

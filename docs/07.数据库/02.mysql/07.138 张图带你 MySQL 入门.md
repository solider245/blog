...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d698719c58066?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1046" height="538"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="526"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="382"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="988" height="458"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="450"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1042" height="546"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="473"></svg>)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d698790fc77ea?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d6987af161272?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
为了演示表连接的功能，我们为 job 表加一个 `type` 字段表示工作类型，增加一个 job\_type 表表示具体的工作种类，如下所示

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6987bb85b8fe?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

下面开始我们的演示

查询出 job 表中的 type 和 job\_type 表中的 type 匹配的姓名和工作类型
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="424"></svg>)
...
为了演示效果我们在 job 表和 job\_type 表中分别添加记录，添加完成后的两表如下

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="1090"></svg>)

下面我们进行左外连接查询：查询出 job 表中的 type 和 job\_type 表中的 type 匹配的姓名和工作类型
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="906" height="712"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="858" height="766"></svg>)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d6987c9115915?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d6987e257be34?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d6987e6f5b11c?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="823"></svg>)

上述结果是查询 job 表中的 type 字段和 job\_type 表中的 type 字段，并把它们进行汇总，可以看出 UNION ALL 只是把所有的结果都列出来了
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="625"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="868"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="446"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1068" height="1280"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1156" height="1280"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="850" height="1280"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="312"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="920"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="532"></svg>)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d698826613ecc?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

然后插入两条数据，执行查询操作

![](https://user-gold-cdn.xitu.io/2020/6/21/172d69882b29dffc?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

如上图所示，使用`zerofill` 可以在数字前面使用 `0` 来进行填充，那么如果宽度超过指定长度后会如何显示？我们来试验一下，向 aId 和 bId 分别插入超过字符限制的数字

![](https://user-gold-cdn.xitu.io/2020/6/21/172d69884eaea922?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

会发现 aId 已经超出了指定范围，那么我们对 aId 插入一个在其允许范围之内的数据

![](https://user-gold-cdn.xitu.io/2020/6/21/172d69884eecb83e?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
除此之外，整数还有一个类型就是 `AUTO_INCREMENT`，在需要产生唯一标识符或者顺序值时，可利用此属性，这个属性只用于整数字符。一个表中最多只有一个 AUTO\_INCREMENT 属性，一般用于`自增主键`，而且 `NOT NULL`，并且是 `PRIMARY KEY` 和 `UNIQUE` 的，主键必须保证唯一性而且不为空。

#### 小数

小数说的是啥？它其实有两种类型；一种是`浮点数`类型，一种是`定点数`类型；

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="300"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="938" height="538"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="924" height="508"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="894" height="506"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="934" height="572"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="862" height="420"></svg>)

然后我们使用 `hex()` 和 `bin()` 函数进行查询

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1116" height="464"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="133"></svg>)

因为 2 的二进制数表示是 `10`，而表中定义的是 `bit(1)` ，所以无法插入。

那么我们将表字段修改一下

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1076" height="224"></svg>)

然后再进行插入，发现已经能够插入了

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="974" height="184"></svg>)

### 日期时间类型

MySQL 中的日期与时间类型，主要包括：**YEAR、TIME、DATE、DATETIME、TIMESTAMP**，每个版本可能不同。下表中列出了这几种类型的属性。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="407"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="437"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="732" height="452"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="956" height="752"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="892" height="740"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="850" height="702"></svg>)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d6988ca9bb487?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d6988d09da812?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="872" height="636"></svg>)
...
MySQL 中有一个环境变量是 sql\_mode ，sql\_mode 支持了 MySQL 的语法、数据校验，我们可以通过下面这种方式来查看当前数据库使用的 sql\_mode
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="758"></svg>)

来源于 [www.cnblogs.com/Zender/p/82…](https://www.cnblogs.com/Zender/p/8270833.html)

### 字符串类型

MySQL 提供了很多种字符串类型，下面是字符串类型的汇总

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="638"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="444"></svg>)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d698904bd6b90?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   `<` 号运算符，当左侧操作数小于右侧操作数时，返回值为 1， 否则其返回值为 0。

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6988f4b07a5f?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="416"></svg>)

*   `IS NULL` 和 `IS NOT NULL` 表示的是是否为 NULL，ISNULL 为 true 返回 1，否则返回 0 ；IS NOT NULL 同理

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="339"></svg>)

*   `IN` 这个比较操作符判断某个值是否在一个集合中，使用方式是 xxx in (value1,value2,value3)

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1158" height="482"></svg>)

*   `LIKE` 运算符的格式是 `xxx LIKE %123%`，比如如下

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="924" height="484"></svg>)

当 like 后面跟的是 `123%` 的时候， xxx 如果是 123 则返回 1，如果是 123xxx 也返回 1，如果是 12 或者 1 就返回 0 。123 是一个整体。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="878" height="474"></svg>)

*   `REGEX` 运算符的格式是 `s REGEXP str` ，匹配时返回值为 1，否则返回 0 。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1042" height="1004"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1070" height="454"></svg>)

*   `AND` 和 `&&` 表示的是逻辑与的逻辑，当所有操作数为非零值并且不为 NULL 时，结果为 1，但凡是有一个 0 则返回 0，操作数中有一个 null 则返回 null

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="448"></svg>)

*   `OR` 和 `||` 表示的是逻辑或，当两个操作数均为非 NULL 值时，如有任意一个操作数为非零值，则结果为 1，否则结果为 0。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="297"></svg>)

*   `XOR` 表示逻辑异或，当任意一个操作数为 NULL 时，返回值为 NULL。对于非 NULL 的操作数，如果两个的逻辑真假值相异，则返回结果 1；否则返回 0。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="402"></svg>)
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d69893b139b3e?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

按位与是一个数值减小的操作

*   `位或` 指的就是按位或，把 | 双方转换为二进制再进行 | 操作

![](https://user-gold-cdn.xitu.io/2020/6/21/172d69894263f410?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

位或是一个数值增大的操作

*   `位异或` 指的就是对操作数的二进制位做异或操作

![](https://user-gold-cdn.xitu.io/2020/6/21/172d69895606334e?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   `位取反` 指的就是对操作数的二进制位做 `NOT` 操作，这里的操作数只能是一位，下面看一个经典的取反例子：对 1 做位取反，具体如下所示：

![](https://user-gold-cdn.xitu.io/2020/6/21/172d69895af30700?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="350"></svg>)

*   `位右移` 是对左操作数向右移动指定位数，例如 50 >> 3，就是对 50 取其二进制然后向右移三位，左边补上 0 ，转换结果如下

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="848" height="470"></svg>)

*   `位左移` 与位右移相反，是对左操作数向左移动指定位数，例如 20 << 2

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="936" height="466"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="445"></svg>)

*   CONCAT(s1,s2 ... sn) ：把传入的参数拼接成一个字符串

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="996" height="456"></svg>)

上面把 `c xu an` 拼接成为了一个字符串，另外需要注意一点，任何和 NULL 进行字符串拼接的结果都是 NULL。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="968" height="458"></svg>)

*   LEFT(str,x) 和 RIGHT(str,x) 函数：分别返回字符串最左边的 x 个字符和最右边的 x 个字符。如果第二个参数是 NULL，那么将不会返回任何字符串

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6989717d587c?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   INSERT(str,x,y,instr) ： 将字符串 str 从指定 x 的位置开始， 取 y 个长度的字串替换为 instr。

![](https://user-gold-cdn.xitu.io/2020/6/21/172d698983119e76?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   LTRIM(str) 和 RTRIM(str) 分别表示去掉字符串 str 左侧和右侧的空格

![](https://user-gold-cdn.xitu.io/2020/6/21/172d698980aa2732?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   REPEAT(str,x) 函数：返回 str 重复 x 次的结果

![](https://user-gold-cdn.xitu.io/2020/6/21/172d698985be9e2c?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   TRIM(str) 函数：用于去掉目标字符串的空格

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6989900f6a02?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   SUBSTRING(str,x,y) 函数：返回从字符串 str 中第 x 位置起 y 个字符长度的字符串

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1118" height="462"></svg>)

*   LPAD(str,n,pad) 和 RPAD(str,n,pad) 函数：用字符串 pad 对 str 左边和右边进行填充，直到长度为 n 个字符长度

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="337"></svg>)

*   STRCMP(s1,s2) 用于比较字符串 s1 和 s2 的 ASCII 值大小。如果 s1 < s2，则返回 \-1；如果 s1 = s2 ，返回 0 ；如果 s1 > s2 ，返回 1。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="326"></svg>)

*   REPLACE(str,a,b) : 用字符串 b 替换字符串 str 种所有出现的字符串 a

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="406"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="934" height="462"></svg>)

*   CEIL(x) 函数： 返回大于 x 的整数

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="940" height="438"></svg>)

*   MOD(x,y)，对 x 和 y 进行取模操作

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="916" height="458"></svg>)

*   ROUND(x,y) 返回 x 四舍五入后保留 y 位小数的值；如果是整数，那么 y 位就是 0 ；如果不指定 y ，那么 y 默认也是 0 。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="922" height="468"></svg>)

*   FLOOR(x) : 返回小于 x 的最大整数，用法与 CEIL 相反

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1020" height="458"></svg>)

*   TRUNCATE(x,y): 返回数字 x 截断为 y 位小数的结果， TRUNCATE 知识截断，并不是四舍五入。

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6989b42424fb?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   RAND() ：返回 0 到 1 的随机值

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6989d2c17e12?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
| CURDATE | 返回当前日期 |
| CURTIME | 返回当前时间 |
| UNIX\_TIMESTAMP | 返回日期 UNIX 时间戳 |
| DATE\_FORMAT | 返回按照字符串格式化的日期 |
| FROM\_UNIXTIME | 返回 UNIX 时间戳的日期值 |
| DATE\_ADD | 返回日期时间 + 上一个时间间隔 |
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="790" height="470"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1070" height="472"></svg>)

*   MONTHNAME(date) 函数：返回 date 的英文月份

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="898" height="468"></svg>)

*   CURDATE() 函数：返回当前日期，只包含年月日

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="682" height="468"></svg>)

*   CURTIME() 函数：返回当前时间，只包含时分秒

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6989f9e140e2?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   UNIX\_TIMESTAMP(date) : 返回 UNIX 的时间戳

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6989ecb58c18?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   FROM\_UNIXTIME(date) : 返回 UNIXTIME 时间戳的日期值，和 UNIX\_TIMESTAMP 相反

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6989f47c27c3?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   DATE\_FORMAT(date,fmt) 函数：按照字符串 fmt 对 date 进行格式化，格式化后按照指定日期格式显示

具体的日期格式可以参考这篇文章 [blog.csdn.net/weixin\_3870…](https://blog.csdn.net/weixin_38703170/article/details/82177837)

我们演示一下将当前日期显示为**年月日**的这种形式，使用的日期格式是 **%M %D %Y**。

![](https://user-gold-cdn.xitu.io/2020/6/21/172d6989ff6f7288?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

*   DATE\_ADD(date, interval, expr type) 函数：返回与所给日期 date 相差 interval 时间段的日期
...
| MINUTE | 分 | mm |
| SECOND | 秒 | ss |
| YEAR\_MONTH | 年和月 | YY\-MM |
| DAY\_HOUR | 日和小时 | DD hh |
| DAY\_MINUTE | 日和分钟 | DD hh : mm |
| DAY\_SECOND | 日和秒 | DD hh ：mm ：ss |
| HOUR\_MINUTE | 小时和分 | hh:mm |
| HOUR\_SECOND | 小时和秒 | hh:ss |
...
![](https://user-gold-cdn.xitu.io/2020/6/21/172d698a169280b4?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
